...
experiment_name = "2504101436_test_DEISchannel_CP_with_dependency_injection_30s_auto_saving"
...
cp_record_dE=0.1
cp_repeat=0
cp_e_range=E_RANGE.E_RANGE_5V
cp_i_range=I_RANGE.I_RANGE_10mA
cp_bandwidth=BANDWIDTH.BW_4
